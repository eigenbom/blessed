...
Tput.prototype._useXtermCap = function() {
  return this.injectTermcap(path.join(__dirname, this.usrPath, 'xterm.termcap'));
};

Tput.prototype._useXtermInfo = function() {
  return this.injectTerminfo(path.join(__dirname, this.usrPath,  'xterm'));
};

Tput.prototype._useInternalInfo = function(name) {
  name = path.basename(name);
  return this.injectTerminfo(path.join(__dirname, this.usrPath, name));
};

Tput.prototype._useInternalCap = function(name) {
  name = path.basename(name);
  return this.injectTermcap(path.join(__dirname, this.usrPath, name + '.termcap'));
};
